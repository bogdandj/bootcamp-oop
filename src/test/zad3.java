/*3. Napisati program koji simulira pretragu “IT Bootcamp” na guglu.
Program cuva rezultate pretrage kao niz podataka (pogledaj link). Korisnik unosi stranu za prikaz
i koliko hoce rezultata da bude prikazano na strani a zatim se rezultati pretrage prikazuju korisniku.*/
...
public class zad3 {
	...
	public static void main(String[] args) {
		...
		String[] rezultatiPretrage = { "ITBootcamp - Besplatna IT prekvalifikacija - Free IT Bootcamp ...",
				"Prijava - Beograd - ITBootcamp", "IT Bootcamp kursevi",
				"IT Bootcamp - Education - Belgrade, Serbia - 1 Review - 342 ...",
				"IT Bootcamp - Образовање - Belgrade, Serbia - 1 утисак ...", "IT Bootcamp | LinkedIn",
				...
				"Free Coding Bootcamp Prep Course | Flatiron School", "Coding Bootcamp Kyoto | Le Wagon",
				"Bootcamps won't make you a coder: Here's what will ...", "2020 Best Coding Bootcamps - SwitchUp.org",
				...
				"Istanbul Coding Bootcamp - Summer 2020 — Re:Coded", "What Are IT Boot Camps? Webopedia Definition",
				"Coding bootcamp - Wikipedia", "IT Bootcamp #2 online edition – Data Analytics in the Cloud",
		...
		System.out.println("Unesite broj prikaza po strani");
		int pr = s.nextInt();



		for (int i = (st - 1) * pr; i < st*pr && i < rezultatiPretrage.length; i++) {
